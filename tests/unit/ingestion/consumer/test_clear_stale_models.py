...
class TestConsumerClearStaleModels:
    def test_clear_stale_headlines(
        ...
        spy_api_headline_manager = mock.Mock(spec_set=APIHeadlineManager)
        consumer = Consumer(
            source_data=example_headline_data,
            filename=test_filename,
            core_headline_manager=spy_core_headline_manager,
            api_headline_manager=spy_api_headline_manager,
        )
        ...
        spy_core_headline_manager.delete_superseded_data.assert_has_calls(
            calls=expected_core_headline_calls
        )
        ...
        expected_api_headline_calls = [
            mock.call(**expected_api_headline_params, is_public=True),
            mock.call(**expected_api_headline_params, is_public=False),
        ]
        spy_api_headline_manager.delete_superseded_data.assert_has_calls(
            calls=expected_api_headline_calls
        )
