...
class TestIngestion:
    ...
    def test_to_outgoing_headline_dto(
        ...
        returned_outgoing_headline_dto: OutgoingHeadlineDTO = (
            ingestion.to_outgoing_headline_dto(
    ...
    @mock.patch.object(Ingestion, "to_outgoing_headline_dto")
    def test_convert_to_outgoing_headline_dtos(
        ...
        # When
        converted_headline_dtos = ingestion._convert_to_outgoing_headline_dtos(
    ...
    def test_to_outgoing_timeseries_dto(
        ...
        returned_outgoing_timseries_dto: OutgoingTimeSeriesDTO = (
            ingestion.to_outgoing_timeseries_dto(
    ...
    @mock.patch.object(Ingestion, "to_outgoing_timeseries_dto")
    def test_convert_to_outgoing_timeseries_dtos(
        ...
        # When
        converted_timeseries_dtos = ingestion._convert_to_outgoing_timeseries_dtos(
    ...
    def test_initializes_with_default_reader(self):
        ...
        assert ingestion.reader.data == mocked_data

    @mock.patch.object(Ingestion, "create_outgoing_headlines_dtos_from_source")
    ...
    @mock.patch.object(Ingestion, "create_outgoing_timeseries_dtos_from_source")
