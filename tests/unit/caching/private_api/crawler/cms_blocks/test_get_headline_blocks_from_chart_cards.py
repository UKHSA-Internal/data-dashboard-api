...
class TestGetHeadlineBlocksFromChartCards:
    def test_returns_correct_headline_blocks(self):
        """
        Given a list of example chart cards
        ...
        """
        # Given
        chart_cards = EXAMPLE_CHART_CARDS

        # When
        headline_blocks = CMSBlockParser.get_headline_blocks_from_chart_cards(
            chart_cards=chart_cards
        )

        # Then
        expected_headline_blocks = [
            chart_cards[0]["value"]["headline_number_columns"][0],
            chart_cards[0]["value"]["headline_number_columns"][1],
            chart_cards[1]["value"]["headline_number_columns"][0],
