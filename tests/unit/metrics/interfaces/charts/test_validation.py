...
def test_does_metric_have_multiple_records_returns_false_for_single_record():
    """
    ...
    fake_core_time_series_manager = FakeCoreTimeSeriesManager(time_series=time_series)
    ...
    # When
    metric_has_multiple_records: bool = validator.does_metric_have_multiple_records()

    # Then
    assert not metric_has_multiple_records


def test_does_metric_have_multiple_records_returns_true_for_multiple_records():
    """
