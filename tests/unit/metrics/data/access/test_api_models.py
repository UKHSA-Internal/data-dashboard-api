...
class TestGetWeeklyDiseaseIncidence:
    def test_returns_filtered_queryset_casted_to_list(self):
        """
        Given a `WeeklyTimeSeriesManager` and a mocked `QuerySet`.
        ...
        """
        # Given
        mocked_weekly_time_series_manager = mock.Mock()
        mocked_queryset = mock.MagicMock(spec=QuerySet)
        mocked_weekly_time_series_manager.get_metric_values_for_weekly_positivity_by_topic.return_value = (
            mocked_queryset
        )
        ...
        weekly_disease_incidence = get_weekly_disease_incidence(
            ...
            weekly_time_series_manager=mocked_weekly_time_series_manager,
        )
