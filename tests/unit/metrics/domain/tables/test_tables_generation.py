...
class TestCombinePlots:
    def test_basic_combine_list_of_plots(self):
        ...
        expected_combined_plots = {
            "2022-09-05": {PLOT_1_LABEL: "10", PLOT_2_LABEL: "20"},
            "2022-09-19": {PLOT_1_LABEL: "22", PLOT_2_LABEL: "45"},
        }
    ...
    def test_different_length_combine_list_of_plots(self):
        ...
        expected_combined_plots = {
            "2022-09-05": {PLOT_1_LABEL: "10", PLOT_2_LABEL: "20"},
            "2022-09-06": {PLOT_1_LABEL: "66"},
            "2022-09-19": {PLOT_1_LABEL: "22", PLOT_2_LABEL: "45"},
            "2022-09-25": {PLOT_1_LABEL: "26"},
        }
...
class TestCreatePlotsInTabularFormat:
    def test_two_plots_with_provided_labels(self):
        ...
        expected_x_axis_values = [dt.strftime("%Y-%m-%d") for dt in X_AXIS_VALUES]
        ...
        assert len(X_AXIS_VALUES) == len(actual_output)
        ...
        actual_y_axis_values = [col["values"][0]["value"] for col in actual_output]
        expected_y_axis_values = [str(val) for val in Y_AXIS_1_VALUES]
        assert expected_y_axis_values == actual_y_axis_values

        # Check the second plot
        actual_y_axis_values = [col["values"][1]["value"] for col in actual_output]
        expected_y_axis_values = [str(val) for val in Y_AXIS_2_VALUES]
        assert expected_y_axis_values == actual_y_axis_values
