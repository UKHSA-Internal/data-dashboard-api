...
from cms.snippets.models.menu_builder.menu_link import MenuLink, SimpleMenuLink
...
class TestSimpleMenuLink:
    ...
    def test_get_prep_value_includes_page_full_url(
        ...
        block = {"title": "ABC", "body": mock.Mock(), "page": mocked_page}
        mocked_get_prep_value.return_value = block
        menu_link = SimpleMenuLink(
            title=block["title"], body=block["body"], page=mocked_page
        )
