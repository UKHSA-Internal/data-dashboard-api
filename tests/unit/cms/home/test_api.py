...
class TestBlankHomePage:
    def test_has_correct_api_fields(self):
        ...
        # Then
        expected_api_field_names = ["body", "related_links", "last_published_at"]
        api_field_names = [api_field.name for api_field in api_fields]
    ...
    def test_has_correct_content_panels(self):
        ...
        # Then
        expected_content_panel_names: Set[str] = {"title", "page_description", "body"}
        content_panel_names = set([p.field_name for p in content_panels])
    ...
    def test_has_correct_sidebar_panels(self):
        ...
        # Then
        expected_sidebar_content_panel_names: Set[str] = {"related_links"}
        sidebar_content_panel_names = set(
