...
def test_plot_background():
    ...
    assert main_layout.plot_bgcolor == colour_scheme.RGBAColours.LIGHT_GREY.stringified
...
def test_plot_with_two_points():
    ...
    for threshold_value in smaller_plot_flattened_matrix[:smaller_plot_threshold_value]:
...
def test_plot_with_three_points():
    """
