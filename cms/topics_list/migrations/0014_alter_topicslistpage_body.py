...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("topics_list", "0013_backfill_theme_subtheme"),
    ]
        ...
        migrations.AlterField(
            ...
            field=wagtail.fields.StreamField(
                ...
                block_lookup={
                    ...
                    89: (
                        ...
                        [
                            [
                                ...
                                ("x_axis", 79),
                                ("x_axis_title", 13),
                                ("primary_field_values", 80),
                                ("y_axis", 81),
                                ("y_axis_title", 15),
                                ("y_axis_minimum_value", 16),
                                ("y_axis_maximum_value", 17),
                                ("chart_type", 82),
                                ("show_timeseries_filter", 83),
                                ("date_prefix", 61),
                                ("static_fields", 84),
                                ("secondary_category", 85),
                                ("segments", 88),
                            ]
                        ],
                        {},
                    ...
                    90: (
                        ...
                        [
                            [
                                ...
                                ("headline_chart_with_description_card", 59),
                                ("chart_with_headline_and_trend_card", 70),
                                ("simplified_chart_with_link", 78),
                                ("dual_category_chart_card", 89),
                            ]
                        ],
                        {
                    ...
                    91: ("wagtail.blocks.StructBlock", [[("cards", 90)]], {}),
                    92: (
                        "wagtail.blocks.TextBlock",
                        (),
                        {
                    ...
                    94: (
                        "wagtail.blocks.StructBlock",
                        [[("title", 4), ("date_prefix", 92), ("rows", 93)]],
                        {},
                    ),
                    95: (
                        "wagtail.blocks.StreamBlock",
                    ...
                    96: ("wagtail.blocks.StructBlock", [[("columns", 95)]], {}),
                    97: (
                        "wagtail.blocks.TextBlock",
                        (),
                        {
                    ...
                    104: (
                        "wagtail.blocks.StreamBlock",
                        [[("headline_number", 64), ("trend_number", 67)]],
                        {
                    ...
                    107: (
                        ...
                        [
                            [
                                ("left_column", 102),
                                ("right_column_top_row", 103),
                                ("right_column_bottom_row", 106),
                            ]
                        ],
                        {},
                    ),
                    108: (
                        ...
                        [
                            [
                                ("text_card", 3),
                                ("chart_card_section", 91),
                                ("headline_numbers_row_card", 96),
                                ("weather_health_alert_card", 101),
                                ("popular_topics_card", 107),
                            ]
                        ],
                        {
                    ...
                    112: (
                        "wagtail.blocks.StructBlock",
                        [[("badge_label", 109), ("text", 110), ("link", 111)]],
                        {"max_num": 1},
                    ),
                    113: (
                        "wagtail.blocks.StreamBlock",
