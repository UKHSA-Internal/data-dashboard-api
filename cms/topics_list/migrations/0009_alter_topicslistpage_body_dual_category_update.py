...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("topics_list", "0008_alter_topicslistpage_body_rename_second_category"),
    ]
        ...
        migrations.AlterField(
            ...
            field=wagtail.fields.StreamField(
                ...
                block_lookup={
                    ...
                    84: (
                        ...
                        [
                            [
                                ...
                                ("y_axis_maximum_value", 17),
                                ("chart_type", 77),
                                ("show_timeseries_filter", 78),
                                ("static_fields", 79),
                                ("secondary_category", 80),
                                ("segments", 83),
                            ]
                        ],
                        {},
                    ...
                    85: (
                        ...
                        [
                            [
                                ...
                                ("chart_with_headline_and_trend_card", 65),
                    ...
                    89: (
                        "wagtail.blocks.StructBlock",
                        [[("title", 4), ("date_prefix", 87), ("rows", 88)]],
                        {},
                    ),
                    90: (
                        "wagtail.blocks.StreamBlock",
                    ...
                    99: (
                        "wagtail.blocks.StreamBlock",
                        [[("headline_number", 59), ("trend_number", 62)]],
                        {
                    ...
                    102: (
                        ...
                        [
                            [
                                ("left_column", 97),
                                ("right_column_top_row", 98),
                                ("right_column_bottom_row", 101),
                            ]
                        ],
                        {},
                    ),
                    103: (
                        ...
                        [
                            [
                                ("text_card", 3),
                                ("chart_card_section", 86),
                                ("headline_numbers_row_card", 91),
                                ("weather_health_alert_card", 96),
                                ("popular_topics_card", 102),
                            ]
                        ],
                        {
                    ...
                    107: (
                        "wagtail.blocks.StructBlock",
                        [[("badge_label", 104), ("text", 105), ("link", 106)]],
                        {"max_num": 1},
                    ),
                    108: (
                        "wagtail.blocks.StreamBlock",
