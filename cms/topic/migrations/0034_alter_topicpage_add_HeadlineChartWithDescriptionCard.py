# Generated by Django 5.2.15 on 2026-07-19 15:37
        ...
        migrations.AlterField(
            ...
            field=wagtail.fields.StreamField(
                ...
                block_lookup={
                    ...
                    87: ("wagtail.blocks.StructBlock", [[("columns", 86)]], {}),
                    88: (
                        "wagtail.blocks.TextBlock",
                        (),
                        {
                    ...
                    90: (
                        "wagtail.blocks.StructBlock",
                        [[("title", 3), ("date_prefix", 88), ("rows", 89)]],
                        {},
                    ),
                    91: (
                        "wagtail.blocks.StreamBlock",
                    ...
                    96: (
                        "wagtail.blocks.StructBlock",
                        [[("label", 93), ("date_from", 94), ("date_to", 95)]],
                        {},
                    ),
                    97: (
                        "wagtail.blocks.StreamBlock",
                    ...
                    98: (
                        "wagtail.blocks.StructBlock",
                        [[("title", 93), ("time_periods", 97)]],
                        {
                            "help_text": "\nThis mandatory time range is used to set the time range that a user can navigate through when\ninteracting with a filter linked chart or map card. Eg. Year selection can include a range of\nyears as dates that can be displayed and navigated between.\nWhen entering multiple periods in the time filter each proceeding `date_from` must be 1 day after the `date_to` \nthat came before it to maintain sequence order.\n",
                            "required": True,
                        },
                    ),
                    99: ("wagtail.blocks.CharBlock", (), {"required": False}),
                    100: (
                        "wagtail.blocks.ChoiceBlock",
                        [],
                        {
                    ...
                    102: (
                        "wagtail.blocks.StructBlock",
                        [[("label", 99), ("colour", 100), ("geography_type", 101)]],
                        {},
                    ),
                    103: (
                        "wagtail.blocks.StreamBlock",
                        [[("geography_filter", 102)]],
                        {
                    ...
                    107: (
                        ...
                        [
                            [
                                ("label", 93),
                                ("colour", 105),
                                ("boundary_minimum_value", 106),
                                ("boundary_maximum_value", 106),
                            ]
                        ],
                        {},
                    ),
                    ...
                    137: ("wagtail.blocks.StructBlock", [[("data_category", 136)]], {}),
                    138: (
                        "wagtail.blocks.StreamBlock",
                        [[("category", 137)]],
                        {
                    ...
                    140: (
                        ...
                        [
                            [
                                ("geography_filters", 104),
                                ("threshold_filters", 109),
                                ("data_filters", 139),
                            ]
                        ],
                        {},
                    ...
                    151: (
                        ...
                        [
                            [
                                ("title_prefix", 144),
                                ("legend_title", 147),
                                ("target_threshold", 148),
                                ("target_threshold_label", 149),
                                ("about", 150),
                            ]
                        ],
                        {
                    ...
                    154: (
                        ...
                        [
                            [
                                ...
                                ("global_filter_card", 143),
                                ("filter_linked_map", 146),
                                ("filter_linked_sub_plot_chart_template", 151),
                                ("filter_linked_time_series_chart_template", 153),
                            ]
                        ],
                        {
