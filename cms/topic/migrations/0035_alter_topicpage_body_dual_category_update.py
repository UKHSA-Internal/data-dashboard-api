# Generated by Django 5.2.15 on 2026-06-30 20:13
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("topic", "0034_alter_topicpage_body_rename_second_category"),
    ]
        ...
        migrations.AlterField(
            ...
            field=wagtail.fields.StreamField(
                ...
                block_lookup={
                    ...
                    83: (
                        ...
                        [
                            [
                                ...
                                ("y_axis_maximum_value", 16),
                                ("chart_type", 76),
                                ("show_timeseries_filter", 77),
                                ("static_fields", 78),
                                ("secondary_category", 79),
                                ("segments", 82),
                            ]
                        ],
                        {},
                    ...
                    94: (
                        "wagtail.blocks.StructBlock",
                        [[("label", 91), ("date_from", 92), ("date_to", 93)]],
                        {},
                    ),
                    95: (
                        "wagtail.blocks.StreamBlock",
                    ...
                    96: (
                        "wagtail.blocks.StructBlock",
                        [[("title", 91), ("time_periods", 95)]],
                        {
                            "help_text": "\nThis mandatory time range is used to set the time range that a user can navigate through when\ninteracting with a filter linked chart or map card. Eg. Year selection can include a range of\nyears as dates that can be displayed and navigated between.\nWhen entering multiple periods in the time filter each proceeding `date_from` must be 1 day after the `date_to` \nthat came before it to maintain sequence order.\n",
                            "required": True,
                        },
                    ),
                    97: ("wagtail.blocks.CharBlock", (), {"required": False}),
                    98: (
                        "wagtail.blocks.ChoiceBlock",
                        [],
                        {
                    ...
                    100: (
                        "wagtail.blocks.StructBlock",
                        [[("label", 97), ("colour", 98), ("geography_type", 99)]],
                        {},
                    ),
                    101: (
                        "wagtail.blocks.StreamBlock",
                        [[("geography_filter", 100)]],
                        {
                    ...
                    105: (
                        ...
                        [
                            [
                                ("label", 91),
                                ("colour", 103),
                                ("boundary_minimum_value", 104),
                                ("boundary_maximum_value", 104),
                            ]
                        ],
                        {},
                    ),
                    ...
                    135: ("wagtail.blocks.StructBlock", [[("data_category", 134)]], {}),
                    136: (
                        "wagtail.blocks.StreamBlock",
                        [[("category", 135)]],
                        {
                    ...
                    138: (
                        ...
                        [
                            [
                                ("geography_filters", 102),
                                ("threshold_filters", 107),
                                ("data_filters", 137),
                            ]
                        ],
                        {},
                    ...
                    149: (
                        ...
                        [
                            [
                                ("title_prefix", 142),
                                ("legend_title", 145),
                                ("target_threshold", 146),
                                ("target_threshold_label", 147),
                                ("about", 148),
                            ]
                        ],
                        {
                    ...
                    152: (
                        ...
                        [
                            [
                                ...
                                ("global_filter_card", 141),
                                ("filter_linked_map", 144),
                                ("filter_linked_sub_plot_chart_template", 149),
                                ("filter_linked_time_series_chart_template", 151),
                            ]
                        ],
                        {
