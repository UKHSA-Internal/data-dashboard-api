# Generated by Django 5.2.12 on 2026-03-11 15:52
                ...
                block_lookup={
                    ...
                    53: (
                        ...
                        [
                            [
                                ...
                                ("confidence_intervals_description", 51),
                                ("confidence_colour", 52),
                            ]
                        ],
                        {},
                    ),
                    ...
                    83: (
                        ...
                        [
                            [
                                ("chart_card", 37),
                                ("chart_with_description_card", 44),
                                ("headline_chart_card", 53),
                                ("chart_with_headline_and_trend_card", 64),
                                ("simplified_chart_with_link", 72),
                                ("dual_category_chart_card", 82),
                            ]
                        ],
                        {
                    ...
                    84: ("wagtail.blocks.StructBlock", [[("columns", 83)]], {}),
                    85: (
                        "wagtail.blocks.TextBlock",
                        (),
                        {
                    ...
                    87: (
                        "wagtail.blocks.StructBlock",
                        [[("title", 3), ("date_prefix", 85), ("rows", 86)]],
                        {},
                    ),
                    88: (
                        "wagtail.blocks.StreamBlock",
                    ...
                    89: ("wagtail.blocks.StructBlock", [[("columns", 88)]], {}),
                    90: (
                        "wagtail.blocks.TextBlock",
                        (),
                        {
                    ...
                    95: (
                        ...
                        [
                            [
                                ("weather_health_alert_card", 94),
                                ("chart_card_with_description", 44),
                            ]
                        ],
                        {
                    ...
                    98: (
                        "wagtail.blocks.StructBlock",
                        [[("title", 3), ("date_prefix", 85), ("metric_cards", 97)]],
                        {
                    ...
                    100: (
                        ...
                        [
                            [
                                ("left_column", 95),
                                ("right_column_top_row", 96),
                                ("right_column_bottom_row", 99),
                            ]
                        ],
                        {},
                    ),
                    ...
                    104: (
                        "wagtail.blocks.StructBlock",
                        [[("label", 101), ("date_from", 102), ("date_to", 103)]],
                        {},
                    ),
                    105: (
                        "wagtail.blocks.StreamBlock",
                    ...
                    110: (
                        "wagtail.blocks.StructBlock",
                        [[("label", 107), ("colour", 108), ("geography_type", 109)]],
                        {},
                    ),
                    111: (
                        "wagtail.blocks.StreamBlock",
                        [[("geography_filter", 110)]],
                        {
                    ...
                    115: (
                        ...
                        [
                            [
                                ("label", 101),
                                ("colour", 113),
                                ("boundary_minimum_value", 114),
                                ("boundary_maximum_value", 114),
                            ]
                        ],
                        {},
                    ),
                    ...
                    145: ("wagtail.blocks.StructBlock", [[("data_category", 144)]], {}),
                    146: (
                        "wagtail.blocks.StreamBlock",
                        [[("category", 145)]],
                        {
                    ...
                    148: (
                        ...
                        [
                            [
                                ("geography_filters", 112),
                                ("threshold_filters", 117),
                                ("data_filters", 147),
                            ]
                        ],
                        {},
                    ...
                    159: (
                        ...
                        [
                            [
                                ("title_prefix", 152),
                                ("legend_title", 155),
                                ("target_threshold", 156),
                                ("target_threshold_label", 157),
                                ("about", 158),
                            ]
                        ],
                        {
                    ...
                    162: (
                        ...
                        [
                            [
                                ("text_card", 2),
                                ("chart_row_card", 84),
                                ("headline_numbers_row_card", 89),
                                ("popular_topics_card", 100),
                                ("global_filter_card", 151),
                                ("filter_linked_map", 154),
                                ("filter_linked_sub_plot_chart_template", 159),
                                ("filter_linked_time_series_chart_template", 161),
                            ]
                        ],
                        {
