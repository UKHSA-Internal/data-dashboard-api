                ...
                block_lookup={
                    ...
                    54: (
                        ...
                        [
                            [
                                ...
                                ("show_timeseries_filter", 20),
                                ("chart", 50),
                                ("confidence_intervals", 51),
                                ("confidence_intervals_description", 52),
                                ("confidence_colour", 53),
                            ]
                        ],
                        {},
                    ),
                    ...
                    87: (
                        ...
                        [
                            [
                                ...
                                ("x_axis", 77),
                                ("x_axis_title", 13),
                                ("primary_field_values", 78),
                                ("y_axis", 79),
                                ("y_axis_title", 15),
                                ("y_axis_minimum_value", 16),
                                ("y_axis_maximum_value", 17),
                                ("chart_type", 80),
                                ("show_timeseries_filter", 81),
                                ("date_prefix", 59),
                                ("static_fields", 82),
                                ("secondary_category", 83),
                                ("segments", 86),
                            ]
                        ],
                        {},
                    ...
                    88: (
                        ...
                        [
                            [
                                ("chart_card", 38),
                                ("chart_with_description_card", 45),
                                ("headline_chart_card", 54),
                                ("headline_chart_with_description_card", 57),
                                ("chart_with_headline_and_trend_card", 68),
                                ("simplified_chart_with_link", 76),
                                ("dual_category_chart_card", 87),
                            ]
                        ],
                        {
                    ...
                    92: (
                        "wagtail.blocks.StructBlock",
                        [[("title", 4), ("date_prefix", 90), ("rows", 91)]],
                        {},
                    ),
                    93: (
                        "wagtail.blocks.StreamBlock",
                    ...
                    94: ("wagtail.blocks.StructBlock", [[("columns", 93)]], {}),
                    95: (
                        "wagtail.blocks.TextBlock",
                        (),
                        {
                    ...
                    100: (
                        ...
                        [
                            [
                                ("weather_health_alert_card", 99),
                                ("chart_card_with_description", 45),
                            ]
                        ],
                        {
                    ...
                    102: (
                        "wagtail.blocks.StreamBlock",
                        [[("headline_number", 62), ("trend_number", 65)]],
                        {
                    ...
                    105: (
                        ...
                        [
                            [
                                ("left_column", 100),
                                ("right_column_top_row", 101),
                                ("right_column_bottom_row", 104),
                            ]
                        ],
                        {},
                    ),
                    106: (
                        ...
                        [
                            [
                                ("text_card", 3),
                                ("chart_card_section", 89),
                                ("headline_numbers_row_card", 94),
                                ("weather_health_alert_card", 99),
                                ("popular_topics_card", 105),
                            ]
                        ],
                        {
                    ...
                    110: (
                        "wagtail.blocks.StructBlock",
                        [[("badge_label", 107), ("text", 108), ("link", 109)]],
                        {"max_num": 1},
                    ),
                    111: (
                        "wagtail.blocks.StreamBlock",
