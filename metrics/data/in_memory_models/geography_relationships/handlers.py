...
def get_relevant_nation(*, geography_code: str):
    try:
...
def get_relevant_region(*, geography_code: str) -> dict[str, str]:
    try:
...
def _get_upstream_relationships_for_region(*, geography_code: str):
    return [get_united_kingdom(), get_relevant_nation(geography_code=geography_code)]


def _get_upstream_relationships_for_utla(*, geography_code: str):
